...
const socials = ref([
    {
        label: 'telegram',
        iconName: 'ic:baseline-telegram',
        to: 'https://t.me/kvantoriumvlz34',
    },
    {
        label: 'vk',
        iconName: 'ri:vk-fill',
        to: 'https://vk.com/public195220786',
    },
    {
        label: 'ok',
        iconName: 'brandico:odnoklassniki-rect',
        to: 'https://ok.ru/group/57811145785374',
    },
])

const kvantoriumContacts = ref([
    {
